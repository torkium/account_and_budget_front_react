...
import ScheduledTransactionOnceFormEdit from "../Forms/ScheduledTransactionOnceFormEdit";
...
const ScheduledTransactionOncePushModal: React.FC<Props> = ({
  isOpen,
  onClose,
  onSubmit,
  ...
  return (
    <Modal
      ...
      size="large"
    >
      <ScheduledTransactionOnceFormEdit scheduledTransaction={scheduledTransaction} onSubmit={onSubmit} />
    </Modal>
  );
};

export default ScheduledTransactionOncePushModal;
